...
class AuditLog(Base):
    ...
    instance_id = Column(Integer, comment="实例ID（已废弃，使用 rdb_instance_id/redis_instance_id）")
    rdb_instance_id = Column(Integer, comment="RDB实例ID")
    redis_instance_id = Column(Integer, comment="Redis实例ID")
