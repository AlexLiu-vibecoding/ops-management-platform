...
| 模块 | 覆盖率 | 说明 |
|------|--------|------|
| app/utils/auth.py | 83% | 密码哈希、JWT、AES加密 |
| app/services/user_service.py | 69% | 用户CRUD、认证 |
| app/services/permission_service.py | 52% | 权限检查 |
| app/services/base.py | 52% | Service基类 |
| app/services/instance_service.py | 28% | 实例管理 |
| app/services/storage.py | 37% | 文件存储 |
